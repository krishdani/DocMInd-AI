  ...
  return (
    <ToastPrimitives.Root
      ...
      className={cn(
        ...
        variant === "default" && "bg-background border-border/80 text-foreground",
        variant === "destructive" && "destructive group border-destructive bg-destructive/10 text-destructive",
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Close
    ref={ref}
    className={cn(
      "absolute right-2 top-2 rounded-md p-1 text-muted-foreground/60 opacity-0 transition-opacity hover:text-foreground focus:opacity-100 focus:outline-none focus:ring-2 group-hover:opacity-100 group-[.destructive]:text-red-300 group-[.destructive]:hover:text-red-550 group-[.destructive]:focus:ring-red-400 group-[.destructive]:focus:ring-offset-red-650",
      className
    )}
    toast-close=""
    {...props}
